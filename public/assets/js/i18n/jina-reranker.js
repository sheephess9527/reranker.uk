window.I18N_PAGE = { zh: {
  "_title": "Jina Reranker：开源权重 + 托管 API 评测 | reranker.uk",
  "_desc": "Jina Reranker 评测：带托管 API 的开源 cross-encoder。涵盖 jina-reranker-v2-base-multilingual、可在浏览器运行的 jina-reranker-v1-tiny-en，以及基准、价格与 Python 用法。",
